      ...
      <div className="hidden lg:flex w-1/2 bg-gray-900 relative overflow-hidden items-center justify-center p-12 text-white">
        ...
        <div className="relative z-10 max-w-lg">
          <div className="flex items-center gap-4 mb-8">
            <div className="w-20 h-20 drop-shadow-xl flex-shrink-0">
              <img src="/logo.png" alt="NagarHelp Logo" className="w-full h-full object-contain select-none" draggable="false" />
            </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 lg:p-12">
        ...
        >
          <div className="text-center lg:text-left">
            ...
            <p className="mt-2 text-gray-500">Join the NagarHelp community</p>
          </div>
