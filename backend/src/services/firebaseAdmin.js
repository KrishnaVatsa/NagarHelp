...
if (!admin.apps.length) {
  console.log('[DEBUG] FIREBASE_STORAGE_BUCKET from env:', process.env.FIREBASE_STORAGE_BUCKET);
  ...
  console.log('[DEBUG] admin.app().options.storageBucket:', admin.app().options.storageBucket);
}
